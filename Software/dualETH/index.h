...
"                <br><p class=left>Stand Alone:"
"                <p class=right><input name=standAloneEnable type=checkbox value=false disabled/>"
"                <p class=right>Stand alone mode allows ArtNet data to be received via the hotspot connection."
"            </div>"
"            <div class=hide name=sections><input name=save type=button value='Save Changes' />"
...
"                <p class=right><input name=dhcpEnable type=checkbox value=false />"
"                <p class=left>IP Address:"
...
"                <p class=left>Enable Port A:"
"                <p class=right><input name=portAEnable type=checkbox value=false />"
